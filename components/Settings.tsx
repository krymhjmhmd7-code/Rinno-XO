      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        ...
        <div className="space-y-3">
          {(() => {
            ...
            const [delPwdConfirm, setDelPwdConfirm] = React.useState('');
            const [delPwdMsg, setDelPwdMsg] = React.useState('');
            ...
            return (
              <>
                <div className="bg-gray-50 p-3 rounded-lg text-sm text-gray-600">
                  كلمة المرور الحالية: <strong className="text-gray-800">{settings.deletePassword || '1234'}</strong>
                </div>
                <input
                  type="password"
                  placeholder="كلمة المرور الجديدة"
